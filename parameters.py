...
epochs = 5 # number of times to run the model on random data, averaging the results for better assessment of model accuracy

ratioTrainingTesting = 0.9 # 0.9 = 90% of data is used for training, 10% is used for testing, 0.8 = 80%-20%, etc
